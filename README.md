About azure-pipelines-language-server-feedstock
===============================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/azure-pipelines-language-server-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/azure-pipelines-language-server-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add azure-pipelines-language-server
# for installing globally
pixi global install azure-pipelines-language-server
```
...
It is possible to list all of the versions of `azure-pipelines-language-server` available on your platform:
...
```
pixi search azure-pipelines-language-server --channel conda-forge
```
